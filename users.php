...
<head>
  ...
  <title>Sparks Internship Bank</title>
</head>
    <style type="text/css">
      td,tr{
...
<body>
        ...
        <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light  bg-secondary">
            ...
            <a class="navbar-brand" href="index.html">Sparks Internship Bank</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item me-2">
                    <a class="nav-link text-capitilize active" href="index.html">Home Page</a>
                </li>
                <li class="nav-item me-2">
                    <a class="nav-link text-capitalize" href="transactionhistory.php">Transaction History</a>
                </li>
                <li class="nav-item me-2">
                    <a class="nav-link text-capitalize" href="transfermoney.php">View Account Balance/Transfer</a>
                </li>
                </ul>
            </div>
            </div>
...
<div class="container design shadow bg-dark">
