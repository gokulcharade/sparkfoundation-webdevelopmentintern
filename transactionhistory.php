...
<body>
        <!-- navigation part  -->
        <nav class="navbar sticky-top navbar-expand-lg navbar-white bg-info bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item me-2">
                    <a class="nav-link text-capitalize" href="transfermoney.php">View Account-statement/Transfer</a>
                </li>
                </ul>
            </div>
            </div>
